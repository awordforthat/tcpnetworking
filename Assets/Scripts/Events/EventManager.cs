...
public class EventTypes:MonoBehaviour
{
	...
	public static string EVENT_SEND_SERVER_TO_CLIENT = "EVENT_SEND_SERVER_TO_CLIENT";
}
	...
	public static EventManager instance
	{
		get
		{
			if(!eventManager)
			{
				...
				if(!eventManager)
				{
					Debug.LogError ("There needs to be one active Event manager script on a game object in your scene");
				}
				else
				{
					eventManager.Init();
